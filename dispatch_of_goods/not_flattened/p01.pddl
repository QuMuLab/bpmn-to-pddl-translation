(define (problem p01-bpmn-no-flatten)
    ...
    ExclusiveGateway_0z5sib0 ExclusiveGateway_1mpgzhg ExclusiveGateway_1ouv9kf InclusiveGateway_0p2e5vq InclusiveGateway_1dgb4sg ParallelGateway_02fgrfq - gateway
        )
        (:init (StartEvent_1))
        (:goal (and (done)))
        )
